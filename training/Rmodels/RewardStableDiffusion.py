...
class RewardStableDiffusion(StableDiffusionPipeline):
    ...
    def apply(
        ...
        SD_latent = latents.clone().detach().cpu().numpy()
        ...
        for i, t in enumerate(timesteps):
            ...
            SD_latent = latent_model_input.clone().detach().cpu().numpy()
            if i != 0 : print("AAAAAAAAAAAAAAAAAAAAAAAA")
        ...
        return image if not return_latents else image, SD_latent
